        ...
        <header className="bg-white border border-blue-100 rounded-3xl shadow-xl p-6 sm:p-10 hv-surface" role="banner">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3" role="group" aria-label="Parcours distributeur">
                {[
                  'Revue des pays',
                  ...
                  <button
                    key={label}
                    type="button"
                    className="inline-flex items-center justify-center px-5 py-3 text-base font-semibold text-blue-700 bg-white hover:bg-blue-50 rounded-xl border border-blue-200 transition-all hv-button hv-focus-ring"
                  >
                    {label}
                  </button>
                ))}
